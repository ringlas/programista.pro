                ...
                <ul>
                    <li data-transition="fade" data-slotamount="10" data-masterspeed="200" data-thumb="images-slider/thumbs/thumb1.jpg">
                        ...
                        <div class="tp-caption ultra-big-white customin customout start"
                            ...
                            <!-- <a id="slider-btn" class="btn btn-border btn-big">Our Expertise</a> -->
                        </div>
                        ...
                        <!-- <div class="tp-caption sfb"
                            ...
                            data-start="800"
                            data-easing="easeInOutExpo">
                            <a href="#" id="slider-btn"  class="btn-slider">Our Expertise
                            </a>
                        </div> -->
                    </li>
                                    ...
                                    <div class="post-content">
                                        <div class="post-image">
                                            <div class="flexslider blog-slider">
                                                ...
                                                <ul class="slides">
                                                    <li>
                                                        <img src="images/works/dcr.png" alt="" />
                                                    </li>                                    
                                                </ul>
                                            </div>
                                    ...
                                    <div class="post-content">
                                        <div class="post-image">
                                            <div class="flexslider blog-slider">
                                                ...
                                                <ul class="slides">
                                                    <li>
                                                        <img src="images/works/nms.png" alt="" />
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <div class="post-content">
                                        <div class="post-image">
                                            <div class="flexslider blog-slider">
                                                ...
                                                <ul class="slides">
                                                    <li>
                                                        <img src="images/works/admin.png" alt="" />
                                                    </li>
                                                </ul>
                                            </div>
                                ...
                                <div class="de_testi">
                                    ...
                                    <div class="de_testi_by">
                                        <div class="de_testi_pic">
                                            <img src="images/testimonial/testi_rob_cromwell.jpg" alt="" class="img-circle">
                                        </div>
                                ...
                                <div class="de_testi">
                                    ...
                                    <div class="de_testi_by">
                                        <span class="de_testi_pic">
                                            <img src="images/testimonial/testi_daniela_nachkova.jpg" alt="" class="img-circle"></span>
                                            <div class="de_testi_company">
                                                <strong>Daniela Nachkova</strong>, CEO of 2x2 Ltd.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="logo-carousel text-center">
                                    <ul id="logo-carousel" class="slides">
                                        <li>
                                            <div class="col-md-2">
                                                <img src="images/logo/logo_sevone.png" alt="SevOne Inc.">
                                            </div>
                                        </li>
                                        <li>
                                            <div class="col-md-2">
                                                <img src="images/logo/logo_2x2.png" alt="">
                                            </div>
                                        </li>
                                        <li>
                                            <div class="col-md-2">
                                                <img src="images/logo/logo_utg_group.png" alt="">
                                            </div>
                                        </li>
                                    </ul>
                                </div>
