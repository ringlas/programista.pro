...
<?php ob_start() ?>
    ...
    <section id="section-about">
        <div class="container">
            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 text-center">
                        ...
                        <h1 class="animated" data-animation="fadeInUp">
                            Programista is an Information Technology
                            <a style="text-decoration: none; cursor: pointer;" id="outstaffing-link"><span class="id-color">Outstaffing*</span></a>
                            Company
                ...
                <!-- featured box begin -->
                <div class="feature-box-small-icon box-fx center col-md-3 animated" data-animation="fadeInUp"
                     data-delay="200">
                    <div class="inner">
                        <div class="front">
                        ...
                        <div class="info">
                            We believe that no matter how good you get at something, competence is still a long journey
                ...
                <div class="feature-box-small-icon box-fx center col-md-3 animated" data-animation="fadeInUp"
                    ...
                    <div class="inner">
                        ...
                        <div class="info">
                            We have been doing this for a long time, successfully completing vastly diverse projects for
                            customers spanning the globe.
                            <br>
                ...
                <div class="feature-box-small-icon box-fx center col-md-3 animated" data-animation="fadeInUp"
                    ...
                    <div class="inner">
                        ...
                        <div class="info">
                            Our customers tell us they appreciate the flexibility of our company and the quality of work
    ...
    <section id="section-about-us-2" class="side-bg no-padding">
        <div class="image-container col-md-5 pull-left animated fadeInLeft" data-animation="fadeInLeft" data-delay="0"
             style="height: 641px; opacity: 0;"></div>

        <div class="container">

            <div class="row">
                <div class="inner-padding">
                    <div class="col-md-6 col-md-offset-6 animated fadeInRight" data-animation="fadeInRight"
                         data-delay="200" style="opacity: 0;">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <p>Programista makes sure they are legally compliant, well-paid, often spoiled, and,
                                    generally speaking, as happy as can be at our well-equipped Class A offices.</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                    ...
                    <div class="inner">
                        ...
                        <div class="text">
                            ...
                            <ul>
                                ...
                                <li>They need Product Managers with expirience in technological and feature research
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="animated" data-animation="fadeInUp" data-delay="200">
                    <div class="col-md-4 bloglist">
                        <div class="post-content">
                            ...
                            <div class="post-text" style="padding-left: 0px;">
                                <h3>
                                    <a href="/pages/projects/2">Filings and Forms data extractor</a>
                                </h3>

                                <a href="/pages/projects/2" class="btn-text">Read More</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 bloglist">
                        <div class="post-content">
                            ...
                            <div class="post-text" style="padding-left: 0px;">
                                <h3>
                                    <a href="/pages/projects/1">Network performance management and
                                        monitoring system</a>
                                </h3>

                                <a href="/pages/projects/1" class="btn-text">Read More</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 bloglist">
                        <div class="post-content">
                            ...
                            <div class="post-text" style="padding-left: 0px;">
                                <h3><a href="/pages/projects/3">Custom accounting system</a></h3>

                                <a href="/pages/projects/3" class="btn-text">Read More</a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div id="testimonial-carousel" class="de_carousel row animated" data-animation="fadeInUp" data-delay="200">
                ...
                <div class="col-md-4 item">
                    <div class="de_testi">
                        <blockquote>
                            <p>The people at Programista; are great minds, but this is not their best quality. What
                                makes them really exceptional is that they think and act as part of your
                                organization.</p>
                        </blockquote>
                        <div class="de_testi_by">
                            <span class="de_testi_pic">
                                ...
                                <div class="de_testi_company">
                                    <strong>Daniela Peleva</strong>, CEO of 2x2 Ltd.
                                </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <form name="contactForm" id='contact_form' method="post" action="/email/send"
                ...
                <div class="col-md-4">
                    <address style="font-family: 'Helvetica Neue', Helvetica;">
                        <span><i
                                class="fa fa-map-marker fa-lg"></i>1, "11-ti Avgust" Street, Plovdiv 4000, Bulgaria</span>
